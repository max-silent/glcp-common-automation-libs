...
# TODO: investigate whether it's duplicated class of "DeviceHistory" (the same URLs).
#  If confirmed - remove "ActivateDeviceDetails" and move its methods to "DeviceHistory".
