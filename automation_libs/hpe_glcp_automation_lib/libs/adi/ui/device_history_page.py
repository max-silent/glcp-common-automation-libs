...
class DeviceHistory(HeaderedPage):
    ...
    def wait_for_loaded_table(self):
        ...
        self.page.wait_for_selector(
            DevicesHistorySelectors.TABLE_ROWS, state="visible", strict=False
        )
    ...
    def should_have_row_with_text_in_column(self, column_name, value):
        ...
        expect(
            self.page.locator(
                DevicesHistorySelectors.TABLE_ROW_TEMPLATE.format(
    ...
    def should_have_valid_date_for_status(
        ...
        date_locator = self.page.locator(
            DevicesHistorySelectors.TABLE_ROW_TEMPLATE.format(matching_rows_indices[0])
        ).nth(0)
