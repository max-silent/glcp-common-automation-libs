...
from hpe_glcp_automation_lib.libs.adi.ui.activate_folder_details_page import (
...
class ActivateFolders(HeaderedPage, SideMenuNavigablePage):
    ...
    def wait_for_loaded_table(self):
        ...
        self.page.wait_for_selector(
            ActivateFoldersSelectors.TABLE_ROWS, state="visible", strict=False
        )
    ...
    def search_for_text(self, search_text, ensure_not_empty=True):
        ...
        self.pw_utils.enter_text_into_element(
            ActivateFoldersSelectors.SEARCH_FIELD, search_text
        )
        if ensure_not_empty:
    ...
    def create_new_folder(self, folder_name, parent_folder="default", description=""):
        ...
        self.page.locator(ActivateFoldersSelectors.FOLDERS_ACTION_BTN).click()
        ...
        self.pw_utils.select_drop_down_element(
            ActivateFoldersSelectors.PARENT_NAME_DROPDOWN, parent_folder, "option"
        )
    ...
    def should_have_row_with_text_in_column(self, column_name, value):
        ...
        expect(
            self.page.locator(
                ActivateFoldersSelectors.TABLE_ROW_TEMPLATE.format(
    ...
    def should_have_row_with_values_in_columns(self, column_to_text_dict):
        ...
        """
        log.info(
            "Playwright: check that row with expected text values in related columns is present in table."
        )
    ...
    def should_have_rows_count(self, count):
        ...
        self.pw_utils.save_screenshot(self.test_name)
        expect(self.page.locator(ActivateFoldersSelectors.TABLE_ROWS)).to_have_count(
            count
        )
        self.page.wait_for_load_state("domcontentloaded")
        return self
