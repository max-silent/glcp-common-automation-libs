    ...
    def aob_data():
        aob_data_default = {
            "app_data": {
                ...
                "logo": "HOKUTST1",
                "msp_supported": True,
                "email_addresses": ["hcloud203+WLVU@gmail.com"],
                "slug": "HOKUTST",
            },
            "instance_data": {
                "short_name": "HOKUTST1",
            ...
            "app_rule_data": {"customer_sticky": False, "description": "App Rule"},
            "instance_rule_data": {
                "description": "App Instance Rule",
                "countries_groups_included": ["AME", "NAM"],
                "countries_groups_excluded": ["EUR"],
                "customers_included": ["ATT", "Sprint"],
                "customers_excluded": ["Costco"],
            },
        }
