...
class ReportMgmt(UISession):
    ...
    def status_check(self):
        ...
        """
        return self.get(url=self._get_path("status"), ignore_handle_response=True)
    ...
    def get_data_source(self):
        return self.get(url=self._get_path("datasources"), ignore_handle_response=True)
    ...
    @_log_response
    def post_export(self, payload):
        return self.post(
            url=self._get_path("exports"), ignore_handle_response=True, json=payload
        )

    @_log_response
    def post_presignedurl(self, payload):
        return self.post(
            url=self._get_path("presignedurl"), ignore_handle_response=True, json=payload
        )
