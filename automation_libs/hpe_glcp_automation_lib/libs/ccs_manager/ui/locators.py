...
class TacCustomersSelectors:
    """Selectors, used in TacCustomersPage class.
    Related URL: ".../manage-ccs/customers".
    """
...
class TacSubscriptionsSelectors:
    SEARCH_FIELD = '[data-testid="search-field"]'
    SUBS_FILTER_BTN = '[data-testid="subscriptions-filter-btn"]'
    CLEAR_FILTER_BTN = '[data-testid="text-clear-filters-anchor"]'

    GENERATE_SUBSCRIPTION_BTN = '[data-testid="generate-subscriptions-btn"]'
    PCID_INPUT_FIELD = '[data-testid="customer-id-input-input"]'
    SUBSCRIPTION_TIER_TEMPLATE = 'label:has-text("{}")>div>nth(1)'
    GENERATE_SUBS_BTN_POPUP = '[data-testid="generate-btn"]'
    CANCEL_BTN_POPUP = '[data-testid="cancel-btn"]'
    PCID_INPUT_FIELD_POPUP = '[data-testid="serial-number-input"]'
    TRANSFER_BTN_POPUP = '[data-testid="transfer-btn"]'
    TRANSFER_ERROR_MSG = '[data-testid="form-global-error"]'

    TABLE_ROWS = '[data-testid="table"]>tbody>tr'
    TABLE_ROW_TEMPLATE = '[data-testid="table"]>tbody>tr:nth-child({})'
    TABLE_ITEM_ACTION_BTN = '[data-testid="subscriptions-action-btn"]'
    TRANSFER_ITEM_ACTION = 'button:has-text("Transfer")'
    MODIFY_ITEM_ACTION = 'button:has-text("Modify")'
    CANCEL_ITEM_ACTION = 'button:has-text("Cancel")'


class TacCustomerDetailsSelectors:
    """Selectors, used in TacCustomerDetailsPage class.
    Related URL: ".../manage-ccs/customers/customer-details".
    """
    ...
    FOLDER_NAME_DROPDOWN = (
        '[data-testid="move-to-folder-form"] input[data-testid="movetofolder-name-input"]'
    )
    MOVE_TO_FOLDER_ACTION_BTN = '[data-testid="move-to-folder-action-btn"]'
    MOVE_CONFIRMATION_BTN = '[data-testid="move-confirmation-btn"]'

    POPUP_END_DATE_FIELD = 'input[name="end_date"]'
    POPUP_QUANTITY_FIELD = 'input[name="quantity"]'
    POPUP_MODIFY_BTN = '[data-testid="modify-btn"]'
    ...
    TABLE_ROWS = '[data-testid="table"]>tbody>tr'
    TABLE_ROW_TEMPLATE = '[data-testid="table"]>tbody>tr:nth-child({})'
    TABLE_ROW_ACTIONS_TEMPLATE = '[data-testid="table"]>tbody>tr:nth-child({}) [data-testid="subscriptions-action-btn"]'
    TABLE_ROW_ACTIONS_ITEM_TEMPLATE = 'button[data-testid^="action-"]:text-is("{}")'
...
class TacDevicesSelectors:
    ...
    SERIALS_OR_MACS_FIELD = (
        '[data-testid="serial-numbers-or-macs-text-area-formfield-area"]'
    )
    ...
    MOVED_DEVICES_POPUP_TITLE = (
        '[data-testid="heading-progress-modal-title"]:has-text("Devices moved")'
    )
...
class TacDeviceDetailsSelectors:
    ...
    NO_DATA_SUBTITLE = "[data-testid = 'no-data-subtitle']"
