...
from hpe_glcp_automation_lib.libs.ccs_manager.ui.tac_customer_details_page import (
    TacCustomerDetailsPage,
)
...
class TacCustomersPage(HeaderedPage, TacMenuNavigablePage):
    ...
    def wait_for_loaded_table(self):
        ...
        self.page.wait_for_selector(
            TacCustomersSelectors.TABLE_ROWS, state="visible", strict=False
        )
    ...
    def search_for_text(self, search_text):
        ...
        self.pw_utils.enter_text_into_element(
            TacCustomersSelectors.SEARCH_FIELD, search_text
        )
    ...
    def click_table_row(self, row_index):
        ...
        self.page.locator(
            TacCustomersSelectors.TABLE_ROW_TEMPLATE.format(row_index)
        ).click()
    ...
    def should_have_row_with_text_in_column(self, column_name, value):
        ...
        expect(
            self.page.locator(
                TacCustomersSelectors.TABLE_ROW_TEMPLATE.format(matching_rows_indices[0])
            )
        ).to_be_visible()
        return self
