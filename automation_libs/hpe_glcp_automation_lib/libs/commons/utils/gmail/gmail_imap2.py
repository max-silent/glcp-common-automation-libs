...
class GmailOps_okta:
                    ...
                    if my_email in email_to:
                        ...
                        for part in email_message.walk():
                            if (
                                ...
                                t1 = my_msg.split()
                                for values in t1:
                                    if "/verify" in values and 'href="https:' in values:
                                        url = values.split('"')[1]
                                        log.info(
    ...
    def get_okta_register_link(self, my_email, gmail_username=None, gmail_password=None):
        try:
            url = None
            response, data = self.check_verification_mail_in_gmail_inbox(
                my_email, gmail_username, gmail_password
                    ...
                    if my_email in email_to:
                        ...
                        for part in email_message.walk():
                            if (
                                ...
                                for values in t1:
                                    if (
                                        "/register" in values or "/sign-up" in values
    ...
    def get_okta_activate_link(self, my_email, gmail_username=None, gmail_password=None):
        try:
            url = None
            response, data = self.check_verification_mail_in_gmail_inbox(
                my_email, gmail_username, gmail_password
                    ...
                    if my_email in email_to:
                        ...
                        for part in email_message.walk():
                            if (
                                ...
                                t1 = my_msg.split()
                                for values in t1:
                                    if "/activate" in values and 'href="https:' in values:
                                        url = values.split('"')[1]
                                        log.info(
                                            "******** URL from email is: {} *******".format(
                                                url
    ...
    def get_okta_password_reset_link(
        self, my_email, gmail_username=None, gmail_password=None
    ):
        try:
            url = None
                    ...
                    if my_email in email_to:
                        ...
                        for part in email_message.walk():
                            if (
                                ...
                                for values in t1:
                                    if (
                                        "/reset" in values or "/update-password" in values
                                    ) and 'href="https:' in values:
                                        url = values.split('"')[1]
                                        log.info(
                                            "******** URL from email is: {} *******".format(
            ...
            log.exception(
                "Unexpected error in getting password reset link from gmail: {}".format(
                    e.args[0]
                )
            )
            return "None"
