...
class ManageAccount(HeaderedPage):
    ...
    def open_api(self):
        """
        Navigate to API by clicking on tile on manage account page.
        :return: new instance of API page object.
        """
        log.info(f"Playwright: navigate to API page")
        self.pw_utils.wait_for_selector(ManageAccountSelectors.CARD_API)
