...
class NavBarSelectors:
    ...
    MENU_ITEM_USER_BUTTON = (
        'button[data-testid="drop-btn-glcp-header-brand-n-profile-menu-item-user"],'
        'button[data-testid="drop-btn-glcp-header-all-menu-item-user"]'
    )
    USER_MENU_POPUP = (
        'div[data-testid="drop-content-glcp-header-brand-n-profile-menu-item-user"],'
    ...
    if is_glcp_wc_header_enabled:
        DASHBOARD_NAV_MENU = "fast-button[part=nav-header-nav-dashboard]"
        APPLICATION_NAV_MENU = "fast-button[part=nav-header-nav-applications]"
        DEVICES_NAV_MENU = "fast-button[part=nav-header-nav-devices]"
        MANAGE_NAV_MENU = "fast-button[part=nav-header-nav-manage]"
        MENU_ITEM_USER_BUTTON = "[part=user-menu-button]"
        USER_MENU_POPUP = "[part=user-menu-button] fast-menu.shown"
        SIGNOUT_MENU = "[part=user-user-profile-dropdown-sign-out]"
        PREFERENCES_NAV_MENU = (
            "[part=user-user-profile-dropdown-hpe-greenlake-preferences]"
        )
        ACCOUNT_DETAILS_NAV_MENU = "[part=user-user-profile-dropdown-hpe-account-details]"
        CUSTOMERS_NAV_MENU = "fast-button[part=nav-header-nav-customers]"
...
class ManageAccountSelectors:
    ...
    CARD_USAGE_REPORTING = "[data-testid='text-usage-reporting-summary']"
