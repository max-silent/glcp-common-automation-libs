...
class SupportAssistantUserApi(UISession):
    """
    ...
    def __init__(self, host, user, password, pcid):
        ...
        self.base_path = "/support-assistant"
    ...
    def get_customers(self, params=None):
        ...
        """
        return self.get(
            url=self._get_path(f"customers"), ignore_handle_response=True, params=params
        )
    ...
    def get_customers_provisions(self, params=None):
        ...
        """
        return self.get(
            url=self._get_path(f"customer-provisions"),
    ...
    def get_customers_detail(self, params):
        ...
        """
        return self.get(
            url=self._get_path(f"customer-detail"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_customers_roles(self, params):
        ...
        """
        return self.get(
            url=self._get_path(f"customer-roles"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_customers_profile_programs(self, pcid):
        ...
        """
        return self.get(
            url=self._get_path(f"customer-programs/{pcid}"), ignore_handle_response=True
        )
    ...
    def get_customers_aliases(self, params):
        ...
        """
        return self.get(
            url=self._get_path(f"aliases"), ignore_handle_response=True, params=params
        )
    ...
    def update_customers_contact(self, payload):
        ...
        """
        return self.put(
            url=self._get_path(f"customer-contact"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def update_customers_preferences(self, payload):
        ...
        """
        return self.put(
            url=self._get_path(f"customer-preferences"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def update_customers_programs(self, payload):
        ...
        """
        return self.put(
            url=self._get_path(f"customer-programs"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def create_customer_aliases(self, payload):
        ...
        """
        return self.post(
            url=self._get_path(f"customers-alias"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def update_customers_aliases(self, payload):
        ...
        """
        return self.put(
            url=self._get_path(f"customers-aliases"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def get_subscriptions(self, params=None):
        ...
        """
        return self.get(
            url=self._get_path(f"subscriptions"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def delete_subscriptions(self, payload):
        ...
        """
        return self.delete(
            url=self._get_path(f"subscription"), ignore_handle_response=True, json=payload
        )
    ...
    def generate_subscriptions(self, payload):
        ...
        """
        return self.post(
            url=self._get_path(f"subscription-eval"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def modify_subscriptions(self, payload):
        ...
        """
        return self.post(
            url=self._get_path(f"subscription-modification"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def transfer_subscriptions(self, payload):
        ...
        """
        return self.put(
            url=self._get_path(f"subscription-transfer"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def get_users(self, params=None):
        ...
        """
        return self.get(
            url=self._get_path(f"users"), ignore_handle_response=True, params=params
        )

    def get_user_roles_assignments(self, params=None):
        """
        Get the list roles assignments of the user
        params:

        platform_customer_id: customer id of the user.
        username : Username of the user

        :return: JSON object of user role assignments
        """
        return self.get(
            url=self._get_path(f"user-role-assignments"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def create_user_re_invite(self, payload):
        ...
        return self.post(
            url=self._get_path(f"user-re-invite"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def delete_users(self, payload):
        ...
        """
        return self.delete(
            url=self._get_path(f"user"), ignore_handle_response=True, json=payload
        )
    ...
    def create_invite_users(self, payload):
        ...
        """
        return self.post(
            url=self._get_path(f"invite-user"), ignore_handle_response=True, json=payload
        )
    ...
    def update_user_roles(self, payload):
        ...
        """
        return self.put(
            url=self._get_path(f"user-roles"), ignore_handle_response=True, json=payload
        )

    def get_tac_user_roles_assignments(self):
        """
        API to get user roles assignments of tac user

        :return: JSON object of user role assignments.
        """
        return self.get(
            url=self._get_path(f"tac-user-role-assignments"), ignore_handle_response=True
        )
    ...
    def get_access(self):
        ...
        """
        return self.get(url=self._get_path(f"manage-access"), ignore_handle_response=True)
    ...
    def get_devices(self, params=None):
        ...
        :return: JSON object of Device list.
        """
        return self.get(
            url=self._get_path(f"devices"), ignore_handle_response=True, params=params
        )
    ...
    def create_devices(self, payload):
        ...
        """
        return self.post(
            url=self._get_path(f"devices"), ignore_handle_response=True, json=payload
        )
    ...
    def get_stats(self):
        ...
        """
        return self.get(url=self._get_path(f"stats"), ignore_handle_response=True)

    def create_stats(self, payload=None):
        """
        Get Device Stats Information for location of a pltform customer
        ...
        """
        return self.post(
            url=self._get_path(f"stats"), ignore_handle_response=True, json=payload
        )
    ...
    def get_activate_orders(self, params=None):
        ...
        """
        return self.get(
            url=self._get_path(f"orders"), ignore_handle_response=True, params=params
        )

    def create_workspace(self, payload):
        """
        API method to create a organizational workspace
        ...
        :return: JSON object of workspace details
        """
        return self.post(
            url=self._get_path(f"workspace"), ignore_handle_response=True, json=payload
        )

    def get_activate_devices(self, params):
        """
        Get Activate Device List of customer/customers
        params:
        ...
        """
        return self.get(
            url=self._get_path(f"activate-devices"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_activate_devices_summary(self, params):
        ...
        """
        return self.get(
            url=self._get_path(f"devices-summary"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_activate_device_details(self, serial_number, params=None):
        ...
        """
        return self.get(
            url=self._get_path(f"device/{serial_number}"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_activate_folders(self, params):
        ...
        """
        return self.get(
            url=self._get_path(f"user-folders"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_activate_folder_rules(self, folder_id, rule_name, params):
        ...
        """
        return self.get(
            url=self._get_path(f"folder/{folder_id}/rule/{rule_name}"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_activate_rules(self, params):
        ...
        """
        return self.get(
            url=self._get_path(f"rules"), ignore_handle_response=True, params=params
        )

    def move_activate_device_to_customer(self, payload):
        """
        API method to move activate devices to customer
        payload:
        {
                "folder_id": 0,
                "folder_name": "string",
        ...
        return self.post(
            url=self._get_path(f"devices-to-customer"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def add_activate_exception_devices(self, payload):
        """
        API to Add Activate SA exception devices
        payload:
        {
          "serial_numbers": [
            "string"
        ...
        """
        return self.post(
            url=self._get_path(f"device-exception"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def create_activate_folder(self, payload):
        """
        API method to create a activate folder for a platform customer
        ...
        """
        return self.post(
            url=self._get_path(f"folder"), ignore_handle_response=True, json=payload
        )
    ...
    def modify_activate_folder(self, folder_id, payload):
        ...
        """
        return self.put(
            url=self._get_path(f"activate-folder/{folder_id}"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def delete_activate_folder(self, folder_id, payload):
        ...
        """
        return self.delete(
            url=self._get_path(f"folder/{folder_id}"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def edit_activate_device_details(self, payload):
        ...
        """
        return self.put(
            url=self._get_path(f"device"), ignore_handle_response=True, json=payload
        )
    ...
    def move_activate_device_to_folder(self, payload):
        ...
        """
        return self.post(
            url=self._get_path(f"device-folder"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def create_activate_folder_rule(self, payload):
        """
        API method to crete activate rule.
        ...
        """
        return self.post(
            url=self._get_path(f"rules"), ignore_handle_response=True, json=payload
        )

    def update_activate_folder_rule(self, rule_id, payload):
        """
        API method to update the activate rule.
        ...
        """
        return self.put(
            url=self._get_path(f"activate-rules/{rule_id}"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def delete_activate_folder_rule(self, rule_id, payload):
        ...
        """
        return self.delete(
            url=self._get_path(f"rule/{rule_id}"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def create_activate_alias(self, payload):
        ...
        """
        return self.post(
            url=self._get_path(f"customer-alias"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def update_activate_alias(self, payload):
        ...
        """
        return self.put(
            url=self._get_path(f"customer-aliases"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def get_activate_order_detail(self, order_number, params=None):
        ...
        """
        return self.get(
            url=self._get_path(f"order/{order_number}"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_activate_inventory_csv(self, params=None):
        ...
        params:
        :platform_customer_id: str
        :return: JSON object of activate inventory data.
        """
        return self.get(
            url=self._get_path(f"export-inventory-csv"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_activate_export_allow_list_cli(self, params=None):
        ...
        :platform_customer_id: str
        :new_format: bool
        :return: JSON object of exported data.
        """
        return self.get(
            url=self._get_path(f"export-allowlist-cli"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def create_activate_export_allow_list_cli(self, params, payload):
        """
        API method to cretae export allowlist cli
    ...
    def get_activate_export_allow_list_csv(self, params=None):
        """
        API method to export allowlist csv.

        params:
        :platform_customer_id: str
        :return: JSON object of activate alias
        """
        return self.get(
            url=self._get_path(f"export-allowlist-csv"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_notification(
        ...
        """
        return self.get(url=self._get_path(f"notifications"), ignore_handle_response=True)
    ...
    def get_notification_details(self, notification_id):
        ...
        """
        return self.get(
            url=self._get_path(f"notifications/{notification_id}"),
            ignore_handle_response=True,
        )
    ...
    def get_audit_logs_search_graphs(self, params: dict = None):
        ...
        """
        return self.get(
            url=self._get_path("auditlogs-search-graphs"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_subscription_orders(self, purchase_order):
        ...
        """
        return self.get(
            url=self._get_path(f"orders-detail/{purchase_order}"),
            ignore_handle_response=True,
        )
    ...
    def update_subscription_orders(self, payload):
        ...
        """
        return self.put(
            url=self._get_path(f"orders"), ignore_handle_response=True, json=payload
        )
    ...
    def get_subscription_orders_with_subscription(self, subscription_key):
        ...
        """
        return self.get(
            url=self._get_path(f"subscription/{subscription_key}"),
            ignore_handle_response=True,
        )

    def get_app_role_assignments(self, params: dict = None):
        """
        Get all the entries of app role assignments
        ...
        return self.get(
            url=self._get_path("app-role-assignments"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_applications(self, params: dict = None):
        ...
        return self.get(
            url=self._get_path("applications"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_application_details(self, application_id: str):
        ...
        return self.get(
            url=self._get_path(f"application/{application_id}"),
            ignore_handle_response=True,
        )
    ...
    def get_app_instances(self, params: dict = None):
        ...
        return self.get(
            url=self._get_path("app-instances"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_app_instance_details(self, app_instance_id: str):
        ...
        return self.get(
            url=self._get_path(f"app-instance/{app_instance_id}"),
            ignore_handle_response=True,
        )
    ...
    def get_customer_rrp(self, params: dict = None):
        ...
        :param params: (optional) Dictionary to be sent in the query string
        :return: response object of resource-restrictions api
        """

        return self.get(
            url=self._get_path("resource-restrictions"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def get_rrp_details(self, rrp_id: str):
        ...
        return self.get(
            url=self._get_path(f"resource-restrictions-detail/{rrp_id}"),
            ignore_handle_response=True,
        )
    ...
    def get_user_rrp(self, params: dict = None):
        ...
        return self.get(
            url=self._get_path("resource-restrictions-users"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def delete_tenant(self, payload: dict):
        ...
        """
        return self.delete(
            url=self._get_path("tenant"), ignore_handle_response=True, json=payload
        )
    ...
    def update_tenant(self, username: str, payload: dict):
        ...
        """
        return self.put(
            url=self._get_path(f"tenant/{username}"),
            ignore_handle_response=True,
            json=payload,
        )
    ...
    def get_ip_access_rule(self, params: dict = None):
        ...
        """
        return self.get(
            url=self._get_path("ip-access-rule"),
            ignore_handle_response=True,
            params=params,
        )
    ...
    def toggle_ip_access_rule(self, params: dict = None):
        ...
        """
        return self.put(
            url=self._get_path("ip-access-rule/toggle"),
            ignore_handle_response=True,
            params=params,
        )
