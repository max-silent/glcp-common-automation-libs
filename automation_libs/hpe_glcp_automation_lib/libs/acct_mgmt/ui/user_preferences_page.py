...
class UserPreferences(HeaderedPage):
    ...
    def update_preferences(self, pref_data: UserPreferencesData = UserPreferencesData):
        ...
        self.pw_utils.select_drop_down_element(
            UserPreferencesSelectors.LANGUAGE_DROPDOWN,
            pref_data.language,
            UserPreferencesSelectors.LANGUAGE_DROP_ROLE,
            exact_match=True,
        )
        self.page.locator(UserPreferencesSelectors.SESSION_TIMEOUT).click()
        self.page.locator(UserPreferencesSelectors.SESSION_TIMEOUT).fill(
            pref_data.timeout
        )
        self.pw_utils.save_screenshot(self.test_name)
        self.page.locator(UserPreferencesSelectors.SAVE_CHANGES_BTN).click()
        return self
