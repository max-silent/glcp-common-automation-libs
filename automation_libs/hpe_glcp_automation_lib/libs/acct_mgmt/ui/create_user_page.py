...
class CreateUserPage(BasePage):
    ...
    def create_user(self, user: CreateUserData = CreateUserData):
        ...
        self.page.locator(
            CreateUserSelectors.INPUT_PASSWORD,
        ...
        self.page.locator(CreateUserSelectors.STREET_ADDRESS).fill(
        ...
        self.page.locator(CreateUserSelectors.STATE_PROVINCE).fill(
        ...
        self.pw_utils.select_drop_down_element(
            CreateUserSelectors.SELECT_COUNTRY, user_data.country
        )
        self.page.locator(CreateUserSelectors.SELECT_LANG).click()
        self.page.locator(
            CreateUserSelectors.SELECT_LANG_DROP.format(user_data.language)
        ).click()
        self.pw_utils.select_drop_down_element(
            CreateUserSelectors.SELECT_TZ, user_data.time_zone
        )
        self.pw_utils.enter_text_into_element(
            CreateUserSelectors.INPUT_PHONE, user_data.phone_number
        )
