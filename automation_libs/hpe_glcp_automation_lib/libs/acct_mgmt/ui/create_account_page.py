...
class CreateAcctPage(BasePage):
    ...
    def create_acct(self, account: CreateUserData = CreateUserData):
        ...
        self.page.locator(CreateAcctSelectors.POSTAL_CODE).fill(account_data.postal_code)
        self.page.locator(CreateAcctSelectors.INPUT_PHONE).fill(account_data.phone_number)
        self.page.locator(CreateAcctSelectors.INPUT_EMAIL).fill(account_data.email)
