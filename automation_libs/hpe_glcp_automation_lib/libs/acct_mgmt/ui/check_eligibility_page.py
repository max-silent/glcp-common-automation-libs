...
from hpe_glcp_automation_lib.libs.acct_mgmt.ui.locators import CheckEligibilitySelectors
...
class CheckEligibility(BasePage):
    ...
    def perform(
        self, eligibility_check_data: CheckEligibilityData = CheckEligibilityData
    ):
        """
        ...
        self.pw_utils.select_drop_down_element(
            CheckEligibilitySelectors.DEVICE_DROP_DOWN,
        ...
        self.pw_utils.select_drop_down_element(
            CheckEligibilitySelectors.SELECT_COUNTRY_DROP_DOWN,
