...
class PasswordData:
    ...
    current_password: InitVar[str]
    rand: InitVar[str] = RandomGenUtils.random_string_of_chars(8)
    new_password: str = field(init=False, default=f"T{rand}P6!")

    def __post_init__(self, current_password, rand):
        self.current_password = current_password
        self.new_password = f"T{rand}P6!"
