...
class CustomerDetails(HeaderedPage):
    ...
    def __init__(self, page: Page, cluster: str, customer_id: str):
        ...
        :param customer_id: customer pcid
        """
        log.info("Initialize Customer Details page object")
    ...
    def edit_customer_details(self, customer_data: CreateUserData = CreateUserData):
        ...
        self.page.locator(CustomerDetailSelectors.CITY).fill(customer_data.city_name)
        self.page.locator(CustomerDetailSelectors.STATE_OR_REGION).fill(
            customer_data.state_or_province
        )
        self.page.locator(CustomerDetailSelectors.ZIP).fill(customer_data.postal_code)
        self.page.locator(CustomerDetailSelectors.EMAIL_DETAILS).fill(customer_data.email)
        ...
        expect(self.page.locator(CustomerDetailSelectors.UPDATE_MSG)).to_be_visible()
